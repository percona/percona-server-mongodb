...
`download <https://www.percona.com/downloads/percona-server-mongodb-4.2/>`_
and use binary tarballs. Follow the `installation
instructions <https://www.percona.com/doc/percona-server-for-mongodb/4.2/install/tarball.html>`_
...
4. Define Percona Server for MongoDB version (4.2.13 for the time of
