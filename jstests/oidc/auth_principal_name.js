...
function test_auth_succeeds_with_default_principal_name_and_auth_claim_disabled(clusterClass) {
    ...
    // don't use auth claims
    const oidcProvider = Object.assign(oidcProviderBase, {principalName: "sub", useAuthorizationClaim: false});
...
function test_auth_fails_with_missing_principla_name_claim(clusterClass) {
    // use auth claims
    const oidcProvider = Object.assign(oidcProviderBase, {
        principalName: "some_other_custom_claim",
