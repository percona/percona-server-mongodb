...
const variants = [
    ...
    },
    {
        ...
        expected_error:
            "BadValue.*configurations without the `matchPattern` field must be " +
    ...
    },
    {
        ...
        expected_error:
            "BadValue.*`issuer` values are equal.*and `audience` values are also " +
    ...
    {
        expected_error:
            "BadValue: Bad value for parameter.*oidcIdentityProviders.*: In " +
    ...
    },
    {
        ...
        expected_error:
            "BadValue: Bad value for parameter.*: BSON field '.*.requestScopes' is " +
    ...
    },
    {
        ...
        expected_error:
            "BadValue: Bad value for parameter.*: BSON field '.*.requestScopes.1' is " +
...
for (const variant of variants) {
    OIDCFixture.assertClusterInitializationFailsWith(StandaloneMongod, variant.config, variant.expected_error);
    OIDCFixture.assertClusterInitializationFailsWith(ShardedCluster, variant.config, variant.expected_error);
}
