...
import {auditTest, getAuditEventsCollection, getDBPath, withinInterval} from "jstests/audit/_audit_helpers.js";
...
auditTest(
    ...
    function (m) {
        ...
        assert.eq(1, rotatedLogPaths.length, "did not get exactly 1 rotated log file: " + rotatedLogPaths);
...
auditTest(
    ...
    function (m) {
        ...
        assert.eq(0, rotatedLogPaths.length, "expected no rotated log file after reopen: " + rotatedLogPaths);
    },
    // Need to enable the logging manager by passing `logpath'
