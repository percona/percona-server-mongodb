...
public:
    ...
    void setHasIdpWithHumanFlowsSupport(bool hasIdpWithHumanFlowsSupport) {
        _hasIdpWithHumanFlowsSupport = hasIdpWithHumanFlowsSupport;
    }
    ...
    bool hasIdpWithHumanFlowsSupport() const override {
        return _hasIdpWithHumanFlowsSupport;
    }
...
protected:
    ...
    bool _hasIdpWithHumanFlowsSupport{false};
