...
2. **Trigger merge**: Click "Run mergai" button or use CLI:
...
4. **Build and test**: Checkout the branch locally, build, and run tests
...
Post a comment with `/fast-forward` to merge without creating extra merge commits.
